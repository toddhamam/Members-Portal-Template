# [BRAND_NAME] Funnel - Claude Context
...
| Domain | Experience |
|--------|------------|
| `[DOMAIN]` | Marketing site with full navigation |
| `offer.[DOMAIN]` | Sales funnel (distraction-free, no navigation) |
...
| `/checkout` | Stripe checkout with order bump | $[MAIN_PRICE] + $[BUMP_PRICE] bump |
| `/upsell-1` | [UPSELL_1_PRODUCT_NAME] | $[UPSELL_1_PRICE] |
| `/downsell-1` | [DOWNSELL_1_PRODUCT_NAME] (shown if upsell-1 declined) | $[DOWNSELL_1_PRICE] |
| `/upsell-2` | [UPSELL_2_PRODUCT_NAME] | $[UPSELL_2_PRICE] |
| `/thank-you` | Order confirmation + account creation | - |

### Products & Slugs
| Product | Slug | Price |
|---------|------|-------|
| [MAIN_PRODUCT_NAME] | `[MAIN_PRODUCT_SLUG]` | $[MAIN_PRICE] |
| [ORDER_BUMP_NAME] | `[ORDER_BUMP_SLUG]` | $[BUMP_PRICE] (order bump) |
| [UPSELL_1_PRODUCT_NAME] | `[UPSELL_1_SLUG]` | $[UPSELL_1_PRICE] |
| [DOWNSELL_1_PRODUCT_NAME] | `[DOWNSELL_1_SLUG]` | $[DOWNSELL_1_PRICE] |
| [UPSELL_2_PRODUCT_NAME] | `[UPSELL_2_SLUG]` | $[UPSELL_2_PRICE] |
...
1. **Authentication > URL Configuration:**
   - **Site URL:** `https://[DOMAIN]` (production domain)
   - **Redirect URLs:** Add all valid callback URLs:
     - `https://[DOMAIN]/auth/callback`
     - `https://offer.[DOMAIN]/auth/callback`
...
**Usage:** Visit `https://offer.[DOMAIN]/api/dashboard/debug` to see full diagnostics.
...
When customizing this template for a new brand, replace these placeholders:

| Placeholder | Description | Example |
|-------------|-------------|---------|
| `[BRAND_NAME]` | Brand name | Inner Wealth Initiate |
| `[DOMAIN]` | Primary domain | innerwealthinitiate.com |
| `[SUPPORT_EMAIL]` | Support email | support@innerwealthinitiate.com |
| `[PRIMARY_COLOR]` | Primary accent color hex | #d4a574 |
| `[SECONDARY_COLOR]` | Secondary accent color hex | #ee5d0b |
| `[GA4_MEASUREMENT_ID]` | GA4 Measurement ID | G-XXXXXXXXXX |
| `[MAIN_PRODUCT_NAME]` | Main product name | Resistance Mapping Guide |
| `[MAIN_PRODUCT_SLUG]` | Main product slug | resistance-mapping-guide |
| `[MAIN_PRICE]` | Main product price | 7 |
| `[ORDER_BUMP_NAME]` | Order bump name | Golden Thread Technique |
| `[ORDER_BUMP_SLUG]` | Order bump slug | golden-thread-technique |
| `[BUMP_PRICE]` | Order bump price | 27 |
| `[UPSELL_1_PRODUCT_NAME]` | Upsell 1 name | The Pathless Path |
| `[UPSELL_1_SLUG]` | Upsell 1 slug | pathless-path |
| `[UPSELL_1_PRICE]` | Upsell 1 price | 97 |
| `[DOWNSELL_1_PRODUCT_NAME]` | Downsell 1 name | Nervous System Reset Kit |
| `[DOWNSELL_1_SLUG]` | Downsell 1 slug | nervous-system-reset |
| `[DOWNSELL_1_PRICE]` | Downsell 1 price | 29 |
| `[UPSELL_2_PRODUCT_NAME]` | Upsell 2 name | Bridge to Mastery |
| `[UPSELL_2_SLUG]` | Upsell 2 slug | bridge-to-mastery |
| `[UPSELL_2_PRICE]` | Upsell 2 price | 0 (or 1495) |
